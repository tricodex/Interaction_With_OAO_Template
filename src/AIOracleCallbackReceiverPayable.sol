...
abstract contract AIOracleCallbackReceiverPayable {
     ...
     */
    function aiOracleCallback(uint256 requestId, bytes calldata output, bytes calldata callbackData) external payable virtual;
